...
const AboutSection = () => {
  return (
    <section id="history" className="bg-[#e9e4d8] md:py-16 py-10">

      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <h2 className="block md:hidden text-4xl font-serif text-[#1c1c5a] mb-6">
          About Us
        </h2>
        ...
        <div className="order-2 md:order-1">
          <h2 className="hidden md:block text-4xl font-serif text-[#1c1c5a] mb-6">
            About Us
          </h2>
